...
#         n_words=10,
#         n_intruders=1,
#         metric_embedder=None,  # Set default to None
#         emb_filename=None,
#         emb_path: str = EMBEDDING_PATH,
#         local_model_path: str = None  # Add local model path as an option
#     ):
#     # def __init__(
#     #     self,
#     #     n_words=10,
...
#         """
#         # Load the model from the local path if provided
#         if local_model_path and os.path.exists(local_model_path):
#             self.metric_embedder = SentenceTransformer(local_model_path)
#         else:
#             # Fallback to default or external model
#             self.metric_embedder = SentenceTransformer(PARAPHRASE_TRANSFORMER_MODEL) if metric_embedder is None else metric_embedder
