...
class ProdLDABase(nn.Module):
    ...
    def __init__(self, dataset, n_topics=10, encoder_dim=128, dropout=0.4):
        super().__init__()
        ...
        self.fc11 = nn.Linear(vocab_size, encoder_dim)
        ...
        self.fcd1 = nn.Linear(n_topics, vocab_size, bias=False)
    ...
    def get_theta(self, x, only_theta=False):
        ...
        """
        norm_x = x / (x.sum(1, keepdim=True) + 1e-12)
    ...
    def decode(self, theta):
        """
        Decode the topic proportions into a distribution over words.
